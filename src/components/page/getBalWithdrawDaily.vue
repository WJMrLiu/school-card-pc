  ...
  <div>
    ...
    <div class="basetable">
      ...
      <div class="tableMain">
        ...
        >
          <el-table-column prop="withdrawAmt" align="center" label=" 取出金额"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    fetchExcel() {
      window.location.href = `${baseUrl}/smmu/sysReport/importBalWithdrawDaily?transDate=${this.handelData.transDate}`;
    },
      ...
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          let result = await request({
            url: "/smmu/sysReport/getBalWithdrawDaily",
            method: "post",
