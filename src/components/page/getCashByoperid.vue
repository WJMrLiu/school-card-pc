    ...
    <div class="basetable">
      ...
      <div class="tableMain">
        ...
        >
          ...
          <el-table-column align="center" prop="transAmt" label="交易金额"></el-table-column>
          <el-table-column align="center" prop="operId" label="操作员编号"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    fetchExcel() {
      window.location.href = `${baseUrl}/smmu/sysReport/importCashByoperid?transDate=${this.handelData.transDate}`;
    },
      ...
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          let result = await request({
            url: "/smmu/sysReport/getCashByoperid",
            method: "post",
